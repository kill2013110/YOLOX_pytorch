...
def g_ghost_regnetx_s(**kwargs):
    return GGhostRegNet(Bottleneck, [1, 3, 5, 7], [64, 128, 256, 512], group_width=32, **kwargs)

# def g_ghost_regnetx_s(**kwargs):
#     return GGhostRegNet(Bottleneck, [1, 3, 5, 7], [64, 128, 256, 512], group_width=24, **kwargs)
if __name__ =="__main__":
    ...
    # net = g_ghost_regnetx_006(classifier=False)
    # net =
    net.training = False
    ...
    img = torch.zeros((2, 3, 640, 640), device=next(net.parameters()).device)
