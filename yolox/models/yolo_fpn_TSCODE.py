...
class YOLO_fpn_TSCODE(nn.Module):
    ...
    def forward(self, input):
        ...
        x00 = self.smallest_conv(x0)  # 1.180672 M

        fpn_out0 = self.lateral_conv0(x0)  # 1024->512/32 # 0.033024
        f_out0 = self.upsample(fpn_out0)  # 512/16
        f_out0 = torch.cat([f_out0, x1], 1)  # 512->1024/16
        f_out0 = self.C3_p4(f_out0)  # 1024->512/16  # 0.09088M

        fpn_out1 = self.reduce_conv1(f_out0)  # 512->256/16 0.00832M
        f_out1 = self.upsample(fpn_out1)  # 256/8
        f_out1 = torch.cat([f_out1, x2], 1)  # 256->512/8
        pan_out2 = self.C3_p3(f_out1)  # 512->256/8 # fpn_out2  0.022912M
