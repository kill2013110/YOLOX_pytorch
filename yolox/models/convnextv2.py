...
if __name__ =="__main__":
    ...
    '''
    convnextv2_atto
backbone flops:17.888768 f
backbone params: 3.36772 M
torch.Size([4, 80, 80, 80])
torch.Size([4, 160, 40, 40])
torch.Size([4, 320, 20, 20])

    convnextv2_femto
backbone flops:25.4773248 f
backbone params: 4.824624 M
    '''
    net = convnextv2_femto(classifier=False)
    # net =
    # net.training = False
